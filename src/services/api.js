...
export const courseAPI = {
    ...
    getCertificateTemplate: (id) => api.get(`/courses/${id}/certificate-template`),
    saveCertificateTemplate: (id, data) => api.put(`/courses/${id}/certificate-template`, data)
}
...
export const moduleAPI = {
    ...
    updateSortOrder: (courseId, items) => api.put(`/courses/${courseId}/modules/sort-order`, { items })
}
...
export const lessonAPI = {
    ...
    updateSortOrder: (moduleId, items) => api.put(`/modules/${moduleId}/lessons/sort-order`, { items }),
    uploadAttachment: (moduleId, lessonId, formData) => api.post(`/modules/${moduleId}/lessons/${lessonId}/attachments`, formData),
    uploadVideo: (moduleId, lessonId, formData) => api.post(`/modules/${moduleId}/lessons/${lessonId}/video`, formData),
    deleteAttachment: (moduleId, id) => api.delete(`/modules/${moduleId}/lessons/attachments/${id}`),
    getAttachmentUrl: (moduleId, id) => `/api/modules/${moduleId}/lessons/attachments/${id}/download`
}
...
export const enrollmentAPI = {
    ...
    approve: (id, approved) => api.put(`/enrollments/${id}/approve`, { approved }),
...
export const progressAPI = {
    ...
    updateVideoPosition: (lessonId, positionSeconds, watchedPercent) =>
        api.put('/progress/video-position', { lessonId, positionSeconds, watchedPercent }),
...
export const quizAPI = {
    ...
    submit: (attemptId, answers) => api.post(`/quizzes/${attemptId}/submit`, { answers }),
...
export const documentAPI = {
    ...
    updatePermissions: (id, data) => api.put(`/documents/${id}/permissions`, data),
    ...
    getVersionDownloadUrl: (versionId) => `/api/documents/versions/${versionId}/download`
}

// Reports
export const reportAPI = {
    getTraining: (courseId) => api.get('/reports/training', { params: { courseId } }),
    getInactive: (days = 30) => api.get('/reports/inactive', { params: { days } }),
...
export const userGroupAPI = {
    ...
    addUser: (groupId, userId) => api.post(`/usergroups/${groupId}/users/${userId}`),
    removeUser: (groupId, userId) => api.delete(`/usergroups/${groupId}/users/${userId}`),
...
export const courseGroupAPI = {
    ...
    addCourse: (groupId, courseId, params) => api.post(`/coursegroups/${groupId}/courses/${courseId}`, null, { params }),
    removeCourse: (groupId, courseId) => api.delete(`/coursegroups/${groupId}/courses/${courseId}`)
}

// Alias để sử dụng tương thích với mã cũ trong component AddDepartment.vue
export const groupAPI = {
    getCourseGroups: (page = 1, pageSize = 100) => api.get('/coursegroups', { params: { page, pageSize } })
}
...
export const rbacAPI = {
    ...
    updateRolePermissions: (roleId, permissionIds) => api.put(`/rbac/roles/${roleId}/permissions`, { permissionIds }),
    ...
    updateUserRoles: (userId, roleIds) => api.put(`/rbac/users/${userId}/roles`, { roleIds }),
}
