...
import { Mail, KeyRound, Lock, ArrowLeft, SendHorizontal, CheckCircle2 } from "lucide-vue-next";
        ...
        <div class="auth-card glass-card">
            ...
            <div v-if="step === 2" class="step-container fadeIn">
                <div class="header">
                    ...
                    <h1>Xác thực OTP</h1>
                    <p>Mã OTP đã được gửi đến <strong>{{ form.email }}</strong>. Vui lòng kiểm tra hộp thư.</p>
                </div>
                ...
                <button class="btn-primary" @click="handleVerifyOtp" :disabled="loading">
                    <span v-if="loading" class="spinner-border spinner-border-sm mr-2"></span>
                    Tiếp tục
                </button>
            ...
            <div v-if="step === 3" class="step-container fadeIn">
                ...
                <button class="btn-primary" @click="handleResetPassword" :disabled="loading">
                    <span v-if="loading" class="spinner-border spinner-border-sm mr-2"></span>
                    Đổi mật khẩu
                </button>
            </div>
            ...
            <div v-if="step === 4" class="step-container fadeIn text-center">
                ...
                <p>Mật khẩu của bạn đã được thay đổi. Giờ đây bạn có thể đăng nhập bằng mật khẩu mới.</p>
                <button class="btn-primary mt-4" @click="router.push('/')">Quay lại Đăng nhập</button>
            </div>
        </div>
    </div>
</template>
...
.btn-primary:hover { background: #2563eb; transform: translateY(-2px); box-shadow: 0 12px 20px -5px rgba(59, 130, 246, 0.3); }
