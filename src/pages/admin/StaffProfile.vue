	...
	<div class="container-fluid py-4">
		...
		<div class="row pb-4 mb-4 align-items-center">
			<div class="col-sm-8 d-flex align-items-center gap-3">
				<button
					class="btn btn-light rounded-circle p-2 shadow-sm border-0 bg-white hover-zoom"
				...
				>
					...
					>
						<div class="avatar-wrap mx-auto">
							<img
								:src="getAvatarUrl()"
								class="profile-img shadow bg-white p-1"
						...
						<div class="d-flex flex-column gap-2 mt-4 px-2">
							<div
								class="d-flex align-items-center justify-content-between p-3 bg-primary-subtle border border-primary-subtle rounded-4 transition-all hover-white"
							>
								<span
									class="fs-13 fw-bold text-primary text-uppercase"
							...
							<div
								class="d-flex align-items-center justify-content-between p-3 bg-success-subtle border border-success-subtle rounded-4 transition-all hover-white"
							>
								<span
									class="fs-13 fw-bold text-success text-uppercase"
									style="letter-spacing: 0.5px"
									>Hoàn thành</span
								>
								<h4 class="mb-0 fw-black text-success">
									{{ stats.completed }}
								</h4>
							</div>
							<div
								class="d-flex align-items-center justify-content-between p-3 bg-warning-subtle border border-warning-subtle rounded-4 transition-all hover-white"
							>
								<span
									class="fs-13 fw-bold text-warning text-uppercase"
									style="letter-spacing: 0.5px"
									>Chứng chỉ</span
								>
								<h4 class="mb-0 fw-black text-warning">
									{{ stats.certificates }}
								</h4>
							</div>
						</div>
				...
				<div class="card border-0 shadow-sm rounded-4 bg-white">
					...
					<div class="card-body p-4">
						<div class="d-flex flex-column gap-3">
							<div
								class="d-flex align-items-center gap-3 p-3 bg-light rounded-3 transition-all hover-white border border-light"
							>
								<div class="bg-white p-2 rounded shadow-sm text-primary">
									<Mail :size="20" />
								</div>
								<div class="overflow-hidden">
									<p class="fs-12 text-muted mb-0 fw-bold text-uppercase">
										Email
									</p>
							...
							<div
								class="d-flex align-items-center gap-3 p-3 bg-light rounded-3 transition-all hover-white border border-light"
							>
								<div class="bg-white p-2 rounded shadow-sm text-info">
									<Shield :size="20" />
								</div>
								<div>
									<p class="fs-12 text-muted mb-0 fw-bold text-uppercase">
							...
							<div
								class="d-flex align-items-center gap-3 p-3 bg-light rounded-3 transition-all hover-white border border-light"
							>
								<div class="bg-white p-2 rounded shadow-sm text-success">
									<Layout :size="20" />
								</div>
								<div>
									<p class="fs-12 text-muted mb-0 fw-bold text-uppercase">
							...
							<div
								class="d-flex align-items-center gap-3 p-3 bg-light rounded-3 transition-all hover-white border border-light"
							>
								<div class="bg-white p-2 rounded shadow-sm text-secondary">
									<Calendar :size="20" />
								</div>
								<div>
									<p class="fs-12 text-muted mb-0 fw-bold text-uppercase">
					...
					<div class="card-body p-4 p-md-5">
						<div v-if="courses.length > 0" class="d-flex flex-column gap-3">
							<div
								...
								:key="course.id"
								class="border rounded-4 p-4 transition-all course-card hover-shadow bg-white"
							>
								<div
									class="d-flex flex-column flex-sm-row justify-content-between align-items-sm-start mb-3 gap-3"
								>
									<div>
										<h6 class="fw-bold mb-1 text-dark fs-15">
											{{ course.title }}
										</h6>
										<span
								...
								<div class="d-flex align-items-center gap-3 mt-4">
									<div
										class="progress flex-grow-1 bg-light shadow-inner"
