			...
			<div class="container nav-inner">
				...
				<div class="nav-btns">
					<button
						class="theme-toggle"
						@click="toggleTheme"
						:title="theme === 'dark' ? 'Chuyển Light' : 'Chuyển Dark'"
					>
					...
					<RouterLink to="/login" class="btn-nav-cta"
		...
		<header class="hero-section" id="hero">
			<div class="container">
				...
				<p class="hero-sub animate-slide-up" style="animation-delay: 0.1s">
					Nền tảng tri thức dành riêng cho nhân sự EDUPOWER. Tích hợp AI, lộ
					trình cá nhân hóa và hệ thống chứng chỉ số chuẩn quốc tế.
				</p>

				<div
					class="hero-cta-row animate-slide-up"
				...
				<div class="hero-proof animate-slide-up" style="animation-delay: 0.26s">
					...
					<span class="proof-text"
						><strong>{{ systemStats.totalStudents }}+</strong> nhân sự đang
						học</span
					>
					<div class="proof-sep"></div>
				...
				<div class="hero-bento animate-fade-in" style="animation-delay: 0.35s">
					<div class="bento-card bento-a glass">
						...
						<div class="bento-stats-row">
							<div class="bs-item">
								<span class="bs-val" style="color: var(--primary-400)">{{
							...
							<div class="bs-sep"></div>
							<div class="bs-item">
								<span class="bs-val" style="color: var(--primary-300)">{{
						...
						<div class="bento-prog-list">
							<div
								class="bprog-item"
								v-for="(c, idx) in realCourses.slice(0, 3)"
								:key="c.id"
							>
								<div
									class="bprog-dot"
									:style="{ background: getBentoColor(idx) }"
								></div>
					...
					<div class="bento-card bento-b bento-gradient">
						<Trophy
							:size="22"
							style="color: rgba(255, 255, 255, 0.9); margin-bottom: 8px"
						/>
					...
					<div class="bento-card bento-c glass">
						...
						<TrendingUp
							:size="20"
							style="color: var(--primary-400); margin-top: auto"
						/>
					</div>
			...
			<div class="container">
				<div class="section-head">
					...
					<h2 class="section-title">
						Trải nghiệm học tập<br /><span class="text-gradient"
							>khác biệt</span
						>
					</h2>
				</div>
				<div class="features-asymmetric">
					<div class="feat-hero-card">
						...
						<div class="feat-hero-content">
							...
							<p class="fhc-desc">
								Hệ thống phân tích kỹ năng hiện tại, xác định điểm thiếu hụt và
								tự động xây dựng lộ trình học tập cá nhân hóa — chính xác đến
								từng bước.
							</p>
							<div class="fhc-tags">
					...
					<div class="feat-mini-stack">
						<div
							class="feat-mini"
							v-for="f in features.filter((_, i) => i !== 1)"
							:key="f.title"
						>
		...
		<section class="section-gap" id="instructors">
			<div class="container">
				<div class="section-head text-center">
					...
					<h2 class="section-title">
						Học từ những <span class="text-gradient">người giỏi nhất</span>
					</h2>
				</div>
				<div class="instructors-grid">
					<div
						class="ins-card"
						v-for="(ins, idx) in instructorCards"
						:key="ins.name"
					>
						...
						<div class="ins-body">
							...
							<div class="ins-chips">
								<span class="badge badge-primary"
									><BookOpen :size="10" /> {{ ins.courses }}</span
								>
								<span class="badge badge-warning"
									><Star :size="10" /> {{ ins.rating }}</span
								>
								<span class="badge badge-primary"
									><Users :size="10" /> {{ ins.students }}</span
								>
							</div>
						</div>
					</div>
		...
		<section class="section-gap section-alt" id="testimonials">
			<div class="container">
				<div class="section-head text-center">
					...
					<h2 class="section-title">
						Hàng trăm người <span class="text-gradient">đã thay đổi</span>
					</h2>
				</div>
		...
		<section class="cta-section">
			<div class="cta-inner">
				...
				<div class="cta-content">
					<div class="section-eyebrow" style="color: var(--primary-300)">
						Bắt đầu ngay hôm nay
					</div>
					<h2 class="cta-headline">
						Sẵn sàng để<br /><em class="cta-em">bứt phá sự nghiệp?</em>
					</h2>
					<p class="cta-sub">
						Hãy tham gia cùng {{ systemStats.totalStudents }} đồng nghiệp để
						cùng nhau xây dựng EDUPOWER vững mạnh.
					</p>
					<div class="cta-urgency">
						<span class="urgency-tag"
							><Check :size="12" /> Miễn phí 7 ngày</span
						>
						<span class="urgency-tag"><Check :size="12" /> Không cần thẻ</span>
						<span class="urgency-tag"
							><Check :size="12" /> Hủy bất cứ lúc nào</span
						>
					</div>
					<div class="cta-btns">
						<button
						...
						<button
							@click="router.push('/login')"
							class="btn btn-cta-ghost btn-lg"
						>
			...
			<div class="container">
				<div class="footer-main">
					<div class="footer-brand">
						<div class="logo-brand mb-3">
							...
							<span class="logo-name"
								>EDU<span class="accent">POWER</span></span
							>
						</div>
						<p class="footer-tagline">
							Nền tảng đào tạo nội bộ thế hệ mới cho nhân sự EDUPOWER.
						</p>
					...
					<div class="footer-col" v-for="col in footerCols" :key="col.h">
						...
						<a href="#" class="footer-link" v-for="l in col.links" :key="l">{{
							l
						}}</a>
					</div>
				</div>
				<div class="footer-bottom">
					<span class="footer-copy"
						>© 2026 EDUPOWER LMS. Build with Precision.</span
					>
...
const features = [
	{
		...
		desc: "Thiết kế tinh giản giúp bạn tập trung vào nội dung bài giảng.",
		tag: "UX/UI",
	},
	{
		num: "02",
		...
		desc: "AI tự động phân tích kỹ năng còn thiếu để đề xuất khóa học phù hợp.",
		tag: "AI-powered",
	},
	{
		num: "03",
		icon: CheckCircle,
		title: "Chứng chỉ số",
		desc: "Xác thực kỹ năng với hệ thống Blockchain nội bộ chuẩn quốc tế.",
		tag: "Blockchain",
	},
	{
		num: "04",
		icon: Zap,
		title: "Tương tác 1:1",
		desc: "Thảo luận trực tiếp với giảng viên và đồng nghiệp ngay trong bài học.",
		tag: "Live",
	},
];
...
const testimonials = [
	{
		...
		role: "Product Manager · FPT Software",
		text: "Khóa học AI của EDUPower giúp tôi ứng dụng ngay vào công việc. Sau 3 tháng tôi đã được thăng chức.",
		img: 15,
		featured: false,
	},
	{
		name: "Nguyễn Thu Trang",
		role: "Data Analyst · Vingroup",
		text: "Lộ trình AI đề xuất hoàn toàn phù hợp với mục tiêu của tôi. Giao diện trực quan, học rất dễ theo dõi.",
		img: 22,
		featured: true,
	},
	{
		name: "Lê Công Đức",
		role: "Team Lead · VNG Corp",
		text: "Hệ thống chứng chỉ blockchain rất ấn tượng và được nhiều nhà tuyển dụng trong ngành công nhận.",
		img: 30,
		featured: false,
	},
];
...
const footerCols = [
	{
		h: "Sản phẩm",
		links: ["Tính năng", "Khóa học", "Lộ trình AI", "Chứng chỉ số"],
	},
...
const instructorCards = computed(() => {
	...
	return uniqueInstructors.value.map((ins, i) => ({
		...ins,
		courses: ins.count,
		...enriched[i % enriched.length],
	}));
});
...
onMounted(async () => {
	try {
		...
		systemStats.value.totalCourses =
			res.data.totalCount || realCourses.value.length;
		systemStats.value.totalStudents = realCourses.value.reduce(
			(a, c) => a + (c.enrollmentCount || 0),
			0,
		);
		systemStats.value.totalInstructors = uniqueInstructors.value.length || 5;
		if (systemStats.value.totalStudents < 100)
			systemStats.value.totalStudents = 450;
		if (systemStats.value.totalCourses === 0)
			systemStats.value.totalCourses = 24;
	} catch {
	} finally {
...
.premium-landing[data-theme="light"] .aurora {
	mix-blend-mode: multiply;
}
.premium-landing[data-theme="light"] .aurora-1 {
	background: rgba(99, 102, 241, 0.09);
}
.premium-landing[data-theme="light"] .aurora-2 {
	background: rgba(168, 85, 247, 0.07);
}
.premium-landing[data-theme="light"] .aurora-3 {
...
.premium-landing[data-theme="light"] .toggle-thumb {
...
.testi-card:not(.testi-featured):hover {
	background: var(--bg-card-hover);
	border-color: var(--border-color-hover);
	transform: translateY(-3px);
	box-shadow: var(--shadow-md);
...
.animate-slide-up {
	animation: slideUp 0.85s cubic-bezier(0.2, 0.8, 0.2, 1) backwards;
}
.animate-fade-in {
